-- Add new columns for LINE integration and notifications
...
-- Add shipping and payment columns to orders
...
-- Create recommendation_links table for secure checkout
...
DROP POLICY IF EXISTS "Public can read valid links by token" ON recommendation_links;
DROP POLICY IF EXISTS "Practitioners can view their recommendation links" ON recommendation_links;
DROP POLICY IF EXISTS "System can create recommendation links" ON recommendation_links;
DROP POLICY IF EXISTS "System can update recommendation links" ON recommendation_links;
